...
public class FlinkTsFileBatchSink {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        schema.extendTemplate(
                DEFAULT_TEMPLATE,
                new MeasurementSchema("sensor_2", TSDataType.INT64, TSEncoding.TS_2DIFF));
        schema.extendTemplate(
                DEFAULT_TEMPLATE,
                new MeasurementSchema("sensor_3", TSDataType.INT64, TSEncoding.TS_2DIFF));
        ...
        // If the parallelism > 1, flink create a directory and each subtask will create a tsfile
        // under the directory.
