...
public class IoTDBRpcDataSet {
        ...
        if (columnNameIndex != null) {
            ...
            for (int i = 0; i < columnNameList.size(); i++) {
                ...
                if (!columnOrdinalMap.containsKey(name)) {
                    ...
                    columnTypeDeduplicatedList.set(
        ...
        if (client != null) {
            try {
                ...
                throw new TException(
                        "Error occurs when connecting to server for close operation ", e);
            }
        }
        client = null;
        isClosed = true;
    ...
    public String findColumnNameByIndex(int columnIndex) throws StatementExecutionException {
        ...
        if (columnIndex > columnNameList.size()) {
            throw new StatementExecutionException(
                    String.format(
                            "column index %d out of range %d", columnIndex, columnNameList.size()));
        }
