...
public class TimeRange implements Comparable<TimeRange> {
     ...
     * <p>[1,3) intersects with (2,5].
     *
     * <p>Note: this method treats [1,3] and [4,5] as two "intersected" interval even if they are
     * not truly intersected.
     *
     ...
     *
     * <p>NOTE the primitive timeRange is always a closed interval [min,max] and only in this
     * function are leftClose and rightClose changed.
     *
