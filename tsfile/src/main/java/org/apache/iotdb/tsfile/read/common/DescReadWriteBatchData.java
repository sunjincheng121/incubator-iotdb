...
public class DescReadWriteBatchData extends DescReadBatchData {
    ...
    public void putBoolean(long t, boolean v) {
        if (writeCurArrayIndex == -1) {
            if (capacity >= CAPACITY_THRESHOLD) {
                ...
                System.arraycopy(
                        booleanRet.get(0), 0, newValueData, newCapacity - capacity, capacity);
    ...
    public void putFloat(long t, float v) {
        if (writeCurArrayIndex == -1) {
            if (capacity >= CAPACITY_THRESHOLD) {
                ...
                System.arraycopy(timeRet.get(0), 0, newTimeData, newCapacity - capacity, capacity);
                System.arraycopy(
                        floatRet.get(0), 0, newValueData, newCapacity - capacity, capacity);
    ...
    public void putDouble(long t, double v) {
        if (writeCurArrayIndex == -1) {
            if (capacity >= CAPACITY_THRESHOLD) {
                ...
                System.arraycopy(timeRet.get(0), 0, newTimeData, newCapacity - capacity, capacity);
                System.arraycopy(
                        doubleRet.get(0), 0, newValueData, newCapacity - capacity, capacity);
    ...
    public void putBinary(long t, Binary v) {
        if (writeCurArrayIndex == -1) {
            if (capacity >= CAPACITY_THRESHOLD) {
                ...
                System.arraycopy(timeRet.get(0), 0, newTimeData, newCapacity - capacity, capacity);
                System.arraycopy(
                        binaryRet.get(0), 0, newValueData, newCapacity - capacity, capacity);
    ...
    public long getTimeByIndex(int idx) {
        return timeRet.get((idx + writeCurArrayIndex + 1) / capacity)[
                (idx + writeCurArrayIndex + 1) % capacity];
    }

    @Override
    public long getLongByIndex(int idx) {
        return longRet.get((idx + writeCurArrayIndex + 1) / capacity)[
                (idx + writeCurArrayIndex + 1) % capacity];
    }
    ...
    public double getDoubleByIndex(int idx) {
        return doubleRet
                .get((idx + writeCurArrayIndex + 1) / capacity)[
                (idx + writeCurArrayIndex + 1) % capacity];
    }

    @Override
    public int getIntByIndex(int idx) {
        return intRet.get((idx + writeCurArrayIndex + 1) / capacity)[
                (idx + writeCurArrayIndex + 1) % capacity];
    }

    @Override
    public float getFloatByIndex(int idx) {
        return floatRet.get((idx + writeCurArrayIndex + 1) / capacity)[
                (idx + writeCurArrayIndex + 1) % capacity];
    }
