...
public final class RamUsageEstimator {
    ...
    static {
        ...
        try {
            ...
            referenceSize =
                    ((Number) arrayIndexScaleM.invoke(theUnsafe, Object[].class)).intValue();
        ...
        // - get the object header size by getting the field offset of the first field of a dummy
        // object
        ...
        try {
            ...
            final int ofs1 =
                    ((Number) objectFieldOffsetM.invoke(theUnsafe, dummy1Field)).intValue();
            final Field dummy2Field = DummyTwoLongObject.class.getDeclaredField("dummy2");
            final int ofs2 =
                    ((Number) objectFieldOffsetM.invoke(theUnsafe, dummy2Field)).intValue();
            if (Math.abs(ofs2 - ofs1) == NUM_BYTES_LONG) {
                final Field baseField = DummyOneFieldObject.class.getDeclaredField("base");
                objectHeader =
                        ((Number) objectFieldOffsetM.invoke(theUnsafe, baseField)).intValue();
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    // Last resort option is an attempt to get it from ManagementFactory's server
                    // anyway (may start AWT).
                    hotSpotBean =
            ...
            if (hotSpotBean != null) {
                ...
                final Object vmOption =
                        getVMOptionMethod.invoke(hotSpotBean, "ObjectAlignmentInBytes");
                objectAlignment =
                        Integer.parseInt(
                                vmOption.getClass()
                                        .getMethod("getValue")
    ...
    // Another test object for checking, if the difference in offsets of dummy1 and dummy2 is 8
    // bytes.
    ...
    public static long sizeOf(double[] arr) {
        return alignObjectSize(
                (long) NUM_BYTES_ARRAY_HEADER + (long) NUM_BYTES_DOUBLE * arr.length);
    }
