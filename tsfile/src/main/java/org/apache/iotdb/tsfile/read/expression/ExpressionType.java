...
public enum ExpressionType {
    ...
    /**
     * This type is used in the pruning process of expression tree in the distributed reading
     * process. When pruning a expression tree for a data group, leaf nodes belonging to other data
     * groups will be set to that type.
     */
    TRUE
}
