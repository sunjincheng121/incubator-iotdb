...
public class ChunkGroupMetaDataV1 {
  ...
  /**
   * Byte offset of the corresponding data in the file Notice: include the chunk group marker. For
   * Hadoop and Spark.
   */
  private long startOffsetOfChunkGroup;

  /**
   * End Byte position of the whole chunk group in the file Notice: position after the chunk group
   * footer. For Hadoop and Spark.
   */
