...
public class BytesUtils {
    ...
    /**
     * convert an integer to a byte array which length is width, then copy this array to the
     * parameter result from pos.
     *
    ...
    /**
     * given a byte array, read width bits from specified position bits and convert it to an
     * integer.
     *
    ...
    /**
     * cut out specified length byte array from parameter start from input byte array src and
     * return.
     *
     ...
     * 1016({00000000 00000000 00000011 111 "1" 1000}) if offset is 9, value is 0 return
     * 488({00000000 00000000 000000 "0" 1 11101000}) if offset is 0, value is 0 return 1000(no
     * change).
     *
     * @param data input int variable
     * @param offset bit offset
