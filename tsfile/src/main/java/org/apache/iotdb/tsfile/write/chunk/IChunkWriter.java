...
public interface IChunkWriter {
    ...
    /**
     * return the serialized size of the chunk header + all pages (not including the un-sealed
     * page). Notice, call this method before calling writeToFileWriter(), otherwise the page buffer
     * in memory will be cleared. <br>
    ...
    void writePageHeaderAndDataIntoBuff(ByteBuffer data, PageHeader header) throws PageException;
}
