...
public class ExpressionOptimizer {
            ...
            if (left.getType() == ExpressionType.GLOBAL_TIME
                ...
                if (relation == ExpressionType.AND) {
                    ...
                    throw new UnsupportedOperationException(
                            "unsupported IExpression type: " + relation);
                }
     ...
     * visits all leaf nodes, which are SingleSeriesExpressions, or AndExpression in right
     * Expression, merge them to the right position in leftExpression.
     *
            ...
            expression =
                    BinaryExpression.or(
                            ...
                            new SingleSeriesExpression(
                                    selectedSeries.get(i), timeFilter.getFilter()));
        }
        return expression;
    }
     ...
     * example: input: QueryFilterAnd/OR( GlobalTimeExpression(timeFilter1),
     * GlobalTimeExpression(timeFilter2) ) output: GlobalTimeExpression(
