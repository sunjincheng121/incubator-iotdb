...
public class IntGorillaEncoder extends GorillaEncoderV2 {
    ...
    private void writeNewLeading(
        ...
        // Maximum number of leadingZeros is stored with 5 bits to allow up to 31 leading zeros,
        // which
        ...
        // Note that in this method the number of meaningful bits is always positive and could be
        // 32,
