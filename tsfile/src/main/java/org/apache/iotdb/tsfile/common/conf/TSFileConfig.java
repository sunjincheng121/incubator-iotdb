...
public class TSFileConfig implements Serializable {
    ...
    /**
     * Encoder of value series. default value is PLAIN. For int, long data type, TsFile also
     * supports TS_2DIFF, REGULAR, GORILLA and RLE(run-length encoding). For float, double data
     * type, TsFile also supports TS_2DIFF, RLE(run-length encoding) and GORILLA. For text data
     * type, TsFile only supports PLAIN.
     */
