            ...
            switch (type) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            "RLE doesn't support data type: " + type);
            }
        }
    ...
    public static class Ts2Diff extends TSEncodingBuilder {
        ...
        public Encoder getEncoder(TSDataType type) {
            switch (type) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            "TS_2DIFF doesn't support data type: " + type);
            }
        }

        @Override
        /**
         * TS_2DIFF could specify <b>max_point_number</b> in given JSON Object, which means the
         * maximum decimal digits for float or double data.
         */
        public void initFromProps(Map<String, String> props) {
            // set max error from initialized map or default value if not set
            if (props == null || !props.containsKey(Encoder.MAX_POINT_NUMBER)) {
    ...
    public static class GorillaV1 extends TSEncodingBuilder {
        ...
        public Encoder getEncoder(TSDataType type) {
            switch (type) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            "GORILLA_V1 doesn't support data type: " + type);
            }
        }
    ...
    public static class Regular extends TSEncodingBuilder {
        ...
        public Encoder getEncoder(TSDataType type) {
            switch (type) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            "REGULAR doesn't support data type: " + type);
            }
        }
    ...
    public static class GorillaV2 extends TSEncodingBuilder {
        ...
        public Encoder getEncoder(TSDataType type) {
            switch (type) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            "GORILLA doesn't support data type: " + type);
            }
        }
