...
public class Tablet {
    ...
    /**
     * Return a tablet with default specified row number. This is the standard constructor (all
     * Tablet should be the same size).
     *
     * @param deviceId the name of the device specified to be written in
     * @param schemas the list of measurement schemas for creating the tablet, only measurementId
    ...
    private void createColumns() {
        ...
        for (int i = 0; i < schemas.size(); i++) {
            ...
            switch (dataType) {
                ...
                default:
                    throw new UnSupportedDataTypeException(
                            String.format(NOT_SUPPORT_DATATYPE, dataType));
            }
        }
    }
