...
public class TimePlainEncodeReadTest {
    ...
    public void queryTwoMeasurementsWithSingleFilterTest() throws IOException {
        ...
        IExpression valFilter =
                new SingleSeriesExpression(new Path("d2", "s2"), ValueFilter.gt(9722L));
        IExpression tFilter =
    ...
    public void queryWithCrossSeriesTimeValueFilterTest() throws IOException {
        ...
        // verify d1.s1, d2.s1
        /**
         * 1480562618950 9501 9502 1480562618954 9541 9542 1480562618955 9551 9552 1480562618956
         * 9561 9562
         */
        int cnt = 1;
        while (dataSet.hasNext()) {
        ...
        valFilter =
                BinaryExpression.and(
                        new SingleSeriesExpression(new Path("d2", "s2"), ValueFilter.ltEq(9312L)),
                        valFilter);
        tFilter =
                BinaryExpression.and(
        ...
        // verify d1.s1, d2.s1
        /**
         * 1480562618910 9101 9102 1480562618911 9111 9112 1480562618912 9121 9122 1480562618913
         * 9131 9132 1480562618914 9141 9142 1480562618915 9151 9152 1480562618930 9301 9302
         * 1480562618931 9311 9312 1480562618932 9321 9322 1480562618933 9331 9332
         */
        cnt = 1;
        while (dataSet.hasNext()) {
            RowRecord r = dataSet.next();
    ...
    public void queryBooleanTest() throws IOException {
        ...
        IExpression valFilter =
                new SingleSeriesExpression(new Path("d1", "s5"), ValueFilter.eq(false));
        IExpression tFilter =
                BinaryExpression.and(
                        new GlobalTimeExpression(TimeFilter.gtEq(1480562618970L)),
    ...
    public void queryStringTest() throws IOException {
        ...
        IExpression valFilter =
                new SingleSeriesExpression(
                        new Path("d1", "s4"), ValueFilter.gt(new Binary("dog97")));
        IExpression tFilter =
                BinaryExpression.and(
                        new GlobalTimeExpression(TimeFilter.gtEq(1480562618970L)),
        ...
        valFilter =
                new SingleSeriesExpression(
                        new Path("d1", "s4"), ValueFilter.lt(new Binary("dog97")));
        tFilter =
                BinaryExpression.and(
                        new GlobalTimeExpression(TimeFilter.gtEq(1480562618970L)),
                        new GlobalTimeExpression(TimeFilter.ltEq(1480562618981L)));
    ...
    public void queryDoubleTest() throws IOException {
        ...
        IExpression valFilter =
                new SingleSeriesExpression(new Path("d1", "s7"), ValueFilter.gt(7.0));
        IExpression tFilter =
                BinaryExpression.and(
