...
public class FileUtilsTest {
    ...
    public void testConvertUnit() {
        ...
        Assert.assertEquals(
                3.0 * 1024,
                FileUtils.transformUnit(kb, FileUtils.Unit.B),
                TestConstant.double_min_delta);
        assertEquals(
                3, FileUtils.transformUnit(kb, FileUtils.Unit.KB), TestConstant.double_min_delta);

        assertEquals(
                3, FileUtils.transformUnit(mb, FileUtils.Unit.MB), TestConstant.double_min_delta);
        assertEquals(
                3, FileUtils.transformUnit(gb, FileUtils.Unit.GB), TestConstant.double_min_delta);
    }
