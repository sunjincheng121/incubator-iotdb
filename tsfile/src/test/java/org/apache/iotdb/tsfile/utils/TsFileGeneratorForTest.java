...
public class TsFileGeneratorForTest {
    ...
    private static Schema generateTestSchema() {
        ...
        schema.registerTimeseries(
                new Path("d1", "s3"),
                new MeasurementSchema("s3", TSDataType.INT64, TSEncoding.TS_2DIFF));
        schema.registerTimeseries(
                new Path("d1", "s4"),
        ...
        schema.registerTimeseries(
                new Path("d1", "s5"),
                new MeasurementSchema("s5", TSDataType.BOOLEAN, TSEncoding.RLE));
        schema.registerTimeseries(
                new Path("d1", "s6"),
                new MeasurementSchema(
                        "s6",
    ...
    public static void writeFileWithOneIncompleteChunkHeader(File file) throws IOException {
        ...
        ChunkHeader header =
                new ChunkHeader(
                        "s1", 100, TSDataType.FLOAT, CompressionType.SNAPPY, TSEncoding.PLAIN, 5);
