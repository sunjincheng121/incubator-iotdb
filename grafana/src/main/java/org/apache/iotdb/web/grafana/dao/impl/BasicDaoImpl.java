...
public class BasicDaoImpl implements BasicDao {
    ...
    /**
     * Note: If the query fails this could be due to AGGREGATIION like AVG on booleayn field. Thus,
     * we then do a retry with FIRST aggregation. This should be solved better in the long run.
     */
    @Override
    public List<TimeValues> querySeries(String s, Pair<ZonedDateTime, ZonedDateTime> timeRange) {
        ...
        try {
            ...
            try {
                ...
                logger.warn(
                        "Even {} query did not succeed, returning NULL now",
                        discreteDataFunction,
                        e2);
