...
public class HDFSFile extends File {
    ...
    public boolean exists() {
        try {
            ...
            logger.error(
                    "Fail to check whether the file {} exists. ", hdfsPath.toUri().toString(), e);
            return false;
        }
    }
    ...
    public boolean isDirectory() {
        try {
            ...
            logger.error(
                    "Fail to judge whether {} is a directory. ", hdfsPath.toUri().toString(), e);
            return false;
        }
    }
    ...
    public boolean renameTo(File dest) {
        try {
            ...
            logger.error(
                    "Failed to rename file {} to {}. ", hdfsPath.toString(), dest.getName(), e);
            return false;
        }
    }
