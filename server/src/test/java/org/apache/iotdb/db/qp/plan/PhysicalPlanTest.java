...
public class PhysicalPlanTest {
    ...
    public void testMetadata() throws QueryProcessException {
        ...
        CreateTimeSeriesPlan plan =
                (CreateTimeSeriesPlan) processor.parseSQLToPhysicalPlan(metadata);
        assertEquals(
    ...
    public void testMetadata3() throws QueryProcessException {
        String metadata =
                "create timeseries root.vehicle.d1.s2(温度) with datatype=int32,encoding=rle, compression=SNAPPY tags(tag1=v1, tag2=v2) attributes(attr1=v1, attr2=v2)";
    ...
    public void testGroupByFill2() {
        ...
        try {
            ...
            for (TSDataType tsDataType : TSDataType.values()) {
                ...
                PreviousFill previousFill =
                        (PreviousFill) groupByFillPlan.getFillType().get(tsDataType);
        ...
        expect =
                BinaryExpression.or(
                        ...
                        new SingleSeriesExpression(
                                new Path("root.vehicle.d1", "s1"), ValueFilter.lt(10.0)));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat1() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(20.5e3));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat2() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(20.5e-3));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat6() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(-2.5e-1));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat7() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(2.5e+2));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat8() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(0.2e+2));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testQueryFloat14() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.gt(-20.0));
        assertEquals(expect.toString(), queryFilter.toString());
    }
    ...
    public void testNotInOperator() throws QueryProcessException {
        ...
        IExpression expect =
                new SingleSeriesExpression(
                        new Path("root.vehicle.d1", "s1"), ValueFilter.in(values, true));
        assertEquals(expect.toString(), queryFilter.toString());
    ...
    public void testRevokeWatermarkEmbedding() throws QueryProcessException {
        ...
        Assert.assertEquals(2, dataAuthPlan.getUsers().size());
        Assert.assertEquals(
                OperatorType.REVOKE_WATERMARK_EMBEDDING, dataAuthPlan.getOperatorType());
    }
    ...
    public void testConfiguration() throws QueryProcessException {
        ...
        LoadConfigurationPlan plan =
                (LoadConfigurationPlan) processor.parseSQLToPhysicalPlan(metadata);
    ...
    public void testSpecialCharacters() throws QueryProcessException {
        String sqlStr1 =
                "create timeseries root.3e-3.-1.1/2.SNAPPY.RLE.81+12.+2.s/io.in[jack].desc with "
