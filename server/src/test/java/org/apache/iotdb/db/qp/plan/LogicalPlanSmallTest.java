...
public class LogicalPlanSmallTest {
    ...
    public void testOffsetOutOfRange() {
        ...
        RootOperator operator =
                (RootOperator) logicalGenerator.generate(sqlStr, ZoneId.systemDefault());
        // expected to throw SQLParserException: Out of range. OFFSET <OFFSETValue>: OFFSETValue
        // should be Int32.
    }
    ...
    public void testSoffsetExceedColumnNum() throws QueryProcessException {
        ...
        // expected to throw LogicalOptimizeException: The value of SOFFSET (%d) is equal to or
        // exceeds the number of sequences (%d) that can actually be returned.
    }
    ...
    public void testDeleteStorageGroup() throws IllegalPathException {
        ...
        Assert.assertEquals(
                path, ((DeleteStorageGroupOperator) operator).getDeletePathList().get(0));
    }
    ...
    public void testChineseCharacter() throws IllegalPathException {
        ...
        Assert.assertEquals(
                new PartialPath("root.一级"), ((SetStorageGroupOperator) operator).getPath());
