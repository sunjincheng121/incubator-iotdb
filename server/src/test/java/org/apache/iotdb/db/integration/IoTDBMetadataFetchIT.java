...
public class IoTDBMetadataFetchIT {
    ...
    public void showDevicesTest() throws SQLException, ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            String[] sqls =
                    new String[] {
                        "show devices root.ln", "show devices root.ln.wf01.wt01.temperature"
                    };
            Set<String>[] standards =
                    new Set[] {
                        new HashSet<>(
                                Arrays.asList("root.ln.wf01.wt01,", "root.ln.wf01.wt01.status,")),
                        new HashSet<>(Collections.singletonList(""))
                    };
    ...
    private void showTimeseriesInJson() {
        ...
        JsonObject expected =
                gson.fromJson(
                        standard.substring(TIME_SERIES_TREE_HEADER.length()), JsonObject.class);
