...
public class TTLTest {
    ...
    @Before
    public void setUp()
            throws MetadataException, IOException, StartupException,
    ...
    public void testTTLRemoval()
        ...
        File unseqDir =
                new File(DirectoryManager.getInstance().getNextFolderForUnSequenceFile(), sg1);
    ...
    public void testParseSetTTL() throws QueryProcessException {
        ...
        SetTTLPlan plan =
                (SetTTLPlan) planner.parseSQLToPhysicalPlan("SET TTL TO " + sg1 + " 10000");
    ...
    public void testParseShowTTL() throws QueryProcessException {
        ...
        plan =
                (ShowTTLPlan)
                        planner.parseSQLToPhysicalPlan("SHOW TTL ON root.sg1,root.sg2,root.sg3");
        assertEquals(
                sgs,
    ...
    public void testShowTTL()
        ...
        QueryDataSet queryDataSet =
                executor.processQuery(plan, EnvironmentUtils.TEST_QUERY_CONTEXT);
