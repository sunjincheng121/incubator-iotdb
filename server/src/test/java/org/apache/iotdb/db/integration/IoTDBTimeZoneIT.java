...
public class IoTDBTimeZoneIT {
     ...
     *
     * <p>set time_zone=+09:00 insert into root.timezone(timestamp,tz1) values(1514789200000,6)
     * insert into root.timezone(timestamp,tz1) values(2018-1-1T14:00:05,7) insert into
     * root.timezone(timestamp,tz1) values(2018-1-1T12:00:03+08:00,8) insert into
     * root.timezone(timestamp,tz1) values(2018-1-1T12:00:04+07:00,9) set time_zone=Asia/Almaty
     * insert into root.timezone(timestamp,tz1) values(1514782807000,10) insert into
        ...
        try (IoTDBConnection connection =
            ...
            try {
                while (resultSet.next()) {
                    String ans =
                            resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(tz1);
