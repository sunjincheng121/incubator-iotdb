...
public class IoTDBTagIT {
        ...
        try (Connection connection =
            ...
            try {
                ...
                assertTrue(
                        e.getMessage()
                                .contains(
                                        "Alias [temperature] for Path [root.turbine.d3.s2] already exist"));
            }
        } catch (Exception e) {
            e.printStackTrace();
            fail();
    ...
    public void createDuplicateAliasTimeseriesTest2() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            try {
                ...
                assertTrue(
                        e.getMessage()
                                .contains("Path [root.turbine.d4.temperature] already exist"));
            }
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        ...
        try (Connection connection =
            ...
            try {
                ...
                assertTrue(
                        e.getMessage()
                                .contains(
                                        "Alias [s1] for Path [root.turbine.d5.s2] already exist"));
            }
        } catch (Exception e) {
            e.printStackTrace();
            fail();
    ...
    public void queryWithWhereContainsTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            boolean hasResult =
                    statement.execute("show timeseries where description contains 'test1'");
            assertTrue(hasResult);
            int count = 0;
            Set<String> res = new HashSet<>();
            try (ResultSet resultSet = statement.getResultSet()) {
    ...
    public void sameNameTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            assertTrue(
                    e.getMessage()
                            .contains("Tag and attribute shouldn't have the same property key"));
        }
    }
