...
public class IoTDBDisableAlignIT {
    ...
    public void errorCaseTest1() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            Assert.assertTrue(
                    e.getMessage().contains("Fill doesn't support disable align clause."));
        }
    }
    ...
    public void errorCaseTest2() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            Assert.assertTrue(
                    e.getMessage().contains("Group by doesn't support disable align clause."));
        }
    }
    ...
    private List<Integer> checkHeader(
        ...
        for (int i = 1; i <= resultSetMetaData.getColumnCount(); i++) {
            ...
            if (typeIndex != null) {
                Assert.assertEquals(
                        expectedTypes[typeIndex], resultSetMetaData.getColumnType(1 + i / 2));
            }
