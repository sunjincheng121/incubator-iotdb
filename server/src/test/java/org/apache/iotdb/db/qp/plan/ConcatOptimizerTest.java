...
public class ConcatOptimizerTest {
    ...
    public void testConcat3() throws QueryProcessException, RecognitionException {
        ...
        assertEquals(
                seriesExpression.toString(), ((RawDataQueryPlan) plan).getExpression().toString());
    }
                ...
                BinaryExpression.and(
                        BinaryExpression.and(
                                new SingleSeriesExpression(
                                        new Path("root.laptop.d1", "s1"), ValueFilter.lt(10)),
                                new SingleSeriesExpression(
                                        new Path("root.laptop.d2", "s1"), ValueFilter.lt(10))),
                        new SingleSeriesExpression(
                                new Path("root.laptop.d3", "s1"), ValueFilter.lt(10)));
