    ...
    public void allPrivilegesTest() throws ClassNotFoundException, SQLException {
        ...
        try (Connection adminCon =
            ...
            try (Connection userCon =
                ...
                try {
                    userStmt.execute(
                            "CREATE TIMESERIES root.a.b WITH DATATYPE=INT32,ENCODING=PLAIN");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    userStmt.execute(
                            "GRANT USER tempuser PRIVILEGES 'CREATE_TIMESERIES' ON root.a");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                adminStmt.execute(
                        "REVOKE USER tempuser PRIVILEGES 'CREATE_TIMESERIES' ON root.b.b");
                ...
                try {
                    userStmt.execute(
                            "CREATE TIMESERIES root.b.b WITH DATATYPE=INT32,ENCODING=PLAIN");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
    ...
    public void illegalGrantRevokeUserTest() throws ClassNotFoundException, SQLException {
        ...
        try (Connection adminCon =
            ...
            try (Connection userCon =
                ...
                try {
                    adminStmt.execute(
                            "GRANT USER nulluser PRIVILEGES 'SET_STORAGE_GROUP' on root.a");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    userStmt.execute(
                            "GRANT USER tempuser PRIVILEGES 'DELETE_TIMESERIES' on root.a.b");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    adminStmt.execute(
                            "REVOKE USER root PRIVILEGES 'DELETE_TIMESERIES' on root.a.b");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    userStmt.execute(
                            "REVOKE USER tempuser PRIVILEGES 'DELETE_TIMESERIES' on root.a.b");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
        ...
        try (Connection adminCon =
            ...
            try (Connection userCon =
                ...
                try {
                    ...
                    adminStmt.execute(
                            "GRANT USER tempuser PRIVILEGES 'SET_STORAGE_GROUP' ON root.a");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    ...
                    userStmt.execute(
                            "CREATE TIMESERIES root.b.a WITH DATATYPE=INT32,ENCODING=PLAIN");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                try {
                    // privilege already exists
                    adminStmt.execute(
                            "GRANT USER tempuser PRIVILEGES 'CREATE_TIMESERIES' ON root.a.b");
                } catch (SQLException e) {
                    caught = true;
                }
                assertTrue(caught);
                ...
                adminStmt.execute(
                        "REVOKE USER tempuser PRIVILEGES 'CREATE_TIMESERIES' ON root.a.b");
                caught = false;
                try {
                    // no privilege to create this one any more
                    userStmt.execute(
    ...
    public void authPerformanceTest() throws ClassNotFoundException, SQLException {
        ...
        try (Connection adminCon =
            ...
            for (int i = 0; i < privilegeCnt; i++) {
                adminStmt.execute(
                        "CREATE TIMESERIES root.a.b" + i + " WITH DATATYPE=INT32,ENCODING=PLAIN");
                adminStmt.execute(
                        "GRANT USER tempuser PRIVILEGES 'INSERT_TIMESERIES' ON root.a.b" + i);
            }
            try (Connection userCon =
                            DriverManager.getConnection(
                                    Config.IOTDB_URL_PREFIX + "127.0.0.1:6667/",
                ...
                if (logger.isInfoEnabled()) {
                    logger.info(
                            "User inserted {} data points used {} ms with {} privileges.",
                            insertCnt,
                ...
                for (int i = 0; i < insertCnt; ) {
                    for (int j = 0; j < batchSize; j++) {
                        adminStmt.addBatch(
                                "INSERT INTO root.a(timestamp, b0) VALUES ("
                                        + (i++ + 1 + insertCnt)
                                        + ", 100)");
                    }
