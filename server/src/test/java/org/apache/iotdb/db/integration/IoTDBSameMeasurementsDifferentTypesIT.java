...
public class IoTDBSameMeasurementsDifferentTypesIT {
    ...
    private static void insertData() throws ClassNotFoundException, SQLException {
        ...
        try (Connection connection =
            ...
            statement.execute(
                    "CREATE TIMESERIES root.fans.d1.s0 WITH DATATYPE=INT64, ENCODING=RLE");
            ...
            for (int time = 1; time < 10; time++) {
                ...
                sql =
                        String.format(
                                "insert into root.fans.d1(timestamp,s0) values(%s,%s)",
                                time, time % 5);
                statement.execute(sql);
            }
    ...
    public void selectAllTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            // use do-while instead of while because in the previous while loop, we have executed
            // the next function,
            ...
            // Although the statement2 has the same sql as statement1, they shouldn't affect each
            // other.
