...
public class IoTDBGroupByFillIT {
                ...
                while (resultSet.next()) {
                    String ans =
                            resultSet.getString(TIMESTAMP_STR)
                                    + ","
                                    + resultSet.getString(
                                            last_value("root.ln.wf01.wt01.temperature"));
    ...
    public void previousTest3() {
        String[] retArray =
                new String[] {
                    "2,null", "7,21", "12,25", "17,25", "22,25", "27,26", "32,29", "37,40", "42,40",
                    "47,40",
                };
    ...
    public void previousUntilLastTest3() {
        String[] retArray =
                new String[] {
                    "2,null", "7,21", "12,25", "17,25", "22,25", "27,26", "32,29", "37,40",
                    "42,null", "47,null",
                };
    ...
    public void leftORightCPreviousUntilLastTest() {
        String[] retArray =
                new String[] {
                    "9,null", "14,25", "19,25", "24,25", "29,26", "34,26", "39,40", "44,null"
                };
