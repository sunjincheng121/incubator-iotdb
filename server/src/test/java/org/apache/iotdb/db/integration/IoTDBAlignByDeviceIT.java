...
public class IoTDBAlignByDeviceIT {
    ...
    public void aggregateTest() throws ClassNotFoundException {
        String[] retArray =
                new String[] {
                    "root.vehicle.d1,2,null,null,null,null,", "root.vehicle.d0,11,11,6,6,1,"
                };
    ...
    public void errorCaseTest3() throws ClassNotFoundException {
        ...
        try (Connection connection =
                        DriverManager.getConnection(
                                Config.IOTDB_URL_PREFIX + "127.0.0.1:6667/", "root", "root");
                Statement statement = connection.createStatement()) {
            boolean hasResultSet = statement.execute("select s0 from root.*.* align by device");
            fail("No exception thrown.");
        } catch (Exception e) {
    ...
    public void unusualCaseTest1() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            boolean hasResultSet =
                    statement.execute("select count(s0) from root.*.* align by device");
            Assert.assertTrue(hasResultSet);
    ...
    public void selectWithStarTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
                ...
                Statement statement = connection.createStatement()) {
            boolean hasResultSet =
                    statement.execute("select * from root.vehicle.d* align by device");
            Assert.assertTrue(hasResultSet);
