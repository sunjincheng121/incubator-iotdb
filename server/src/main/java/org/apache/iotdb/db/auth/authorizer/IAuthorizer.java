...
public interface IAuthorizer {
     ...
     * @throws AuthException if the given username or password is illegal or the user already
     *     exists.
     */
     ...
     *
     * @param username the username of the user.
     * @throws AuthException When attempting to delete the default administrator or the user does
     *     not exists.
     */
     ...
     *     illegal or the permission already exists.
     */
     ...
     * @param privilegeId An integer that represents a privilege.
     * @throws AuthException If the user does not exist or the privilege or the seriesPath is
     *     illegal or if the permission does not exist.
     */
     ...
     *     illegal or the privilege already exists.
     */
     ...
     * @param privilegeId An integer that represents a privilege.
     * @throws AuthException If the role does not exist or the privilege or the seriesPath is
     *     illegal or the privilege does not exists.
     */
