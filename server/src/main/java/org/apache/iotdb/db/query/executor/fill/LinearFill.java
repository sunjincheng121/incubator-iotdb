    ...
    protected TimeValuePair calculatePrecedingPoint()
        ...
        QueryDataSource dataSource =
                QueryResourceManager.getInstance()
                        .getQueryDataSource(seriesPath, context, beforeFilter);
        ...
        switch (dataType) {
            case INT32:
                ...
                int fillIntValue =
                        startIntValue
                                + (int)
                                        ((double) (endIntValue - startIntValue)
                                                / totalTimeLength
                                                * beforeTimeLength);
            ...
            case INT64:
                ...
                long fillLongValue =
                        startLongValue
                                + (long)
                                        ((double) (endLongValue - startLongValue)
                                                / totalTimeLength
                                                * beforeTimeLength);
            ...
            case DOUBLE:
                ...
                double fillDoubleValue =
                        startDoubleValue
                                + ((endDoubleValue - startDoubleValue)
                                        / totalTimeLength
                                        * beforeTimeLength);
