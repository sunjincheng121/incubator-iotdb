...
public class IoTDBDescriptor {
    ...
    public void replaceProps(String[] params) {
        ...
        Option rpcPort =
                new Option(RPC_PORT, RPC_PORT, true, "The jdbc service listens on the port");
    ...
    public URL getPropsUrl() {
        ...
        if (urlString == null) {
            ...
            if (urlString != null) {
                ...
                // If this too wasn't provided, try to find a default config in the root of the
                // classpath.
    ...
    private void loadProps() {
        ...
        try (InputStream inputStream = url.openStream()) {
            ...
            conf.setEnableMetricService(
                    Boolean.parseBoolean(
                            properties.getProperty(
                                    "enable_metric_service",
                                    Boolean.toString(conf.isEnableMetricService()))));

            conf.setMetricsPort(
                    Integer.parseInt(
                            properties.getProperty(
                                    "metrics_port", Integer.toString(conf.getMetricsPort()))));
            ...
            conf.setRpcPort(
                    Integer.parseInt(
                            properties.getProperty(
                                    "rpc_port", Integer.toString(conf.getRpcPort()))));
            ...
            if (systemDir == null) {
                ...
                if (systemDir != null) {
                    systemDir =
                            FilePathUtils.regularizePath(systemDir)
            ...
            conf.setQueryDir(
                    FilePathUtils.regularizePath(
                            conf.getSystemDir() + IoTDBConstant.QUERY_FOLDER_NAME));
            ...
            int walBufferSize =
                    Integer.parseInt(
                            properties.getProperty(
                                    "wal_buffer_size", Integer.toString(conf.getWalBufferSize())));
            if (walBufferSize > 0) {
            ...
            conf.setMultiDirStrategyClassName(
                    properties.getProperty(
                            "multi_dir_strategy", conf.getMultiDirStrategyClassName()));

            conf.setBatchSize(
                    Integer.parseInt(
                            properties.getProperty(
                                    "batch_size", Integer.toString(conf.getBatchSize()))));
                    ...
                    Long.parseLong(
                            properties
                                    .getProperty(
                                            ...
                                            Long.toString(conf.getTsFileSizeThreshold()))
                                    .trim());
            ...
            conf.setSeqLevelNum(
                    Integer.parseInt(
                            properties.getProperty(
                                    "seq_level_num", Integer.toString(conf.getSeqLevelNum()))));
            ...
            conf.setSyncEnable(
                    Boolean.parseBoolean(
                            properties.getProperty(
                                    "is_sync_enable", Boolean.toString(conf.isSyncEnable()))));
            ...
            conf.setSyncServerPort(
                    Integer.parseInt(
                            properties
                                    .getProperty(
                                            "sync_server_port",
                                            Integer.toString(conf.getSyncServerPort()))
                                    .trim()));
            ...
            conf.setEnableIndex(
                    Boolean.parseBoolean(
                            properties.getProperty(
                                    "enable_index", Boolean.toString(conf.isEnableIndex()))));
                    ...
                    Integer.parseInt(
                            properties
                                    .getProperty(
                                            ...
                                            Integer.toString(conf.getmManagerCacheSize()))
                                    .trim()));
            ...
            conf.setCompactionThreadNum(
                    Integer.parseInt(
                            properties.getProperty(
                                    ...
                                    Integer.toString(conf.getCompactionThreadNum()))));
            ...
            conf.setTsFileStorageFs(
                    properties.getProperty(
                            "tsfile_storage_fs", conf.getTsFileStorageFs().toString()));
            ...
            conf.setDefaultTTL(
                    Long.parseLong(
                            properties.getProperty(
                                    "default_ttl", String.valueOf(conf.getDefaultTTL()))));
            ...
            conf.setThriftInitBufferSize(
                    Integer.parseInt(
                            properties.getProperty(
                                    ...
                                    String.valueOf(conf.getThriftInitBufferSize()))));
            ...
            conf.setDebugState(
                    Boolean.parseBoolean(
                            properties.getProperty(
                                    "debug_state", String.valueOf(conf.isDebugOn()))));
            ...
            if (properties.getProperty(IoTDBConstant.MQTT_PORT_NAME) != null) {
                conf.setMqttPort(
                        Integer.parseInt(properties.getProperty(IoTDBConstant.MQTT_PORT_NAME)));
            }
            if (properties.getProperty(IoTDBConstant.MQTT_HANDLER_POOL_SIZE_NAME) != null) {
                conf.setMqttHandlerPoolSize(
                        Integer.parseInt(
                                properties.getProperty(IoTDBConstant.MQTT_HANDLER_POOL_SIZE_NAME)));
            }
            ...
            if (properties.getProperty(IoTDBConstant.MQTT_MAX_MESSAGE_SIZE) != null) {
                conf.setMqttMaxMessageSize(
                        Integer.parseInt(
                                properties.getProperty(IoTDBConstant.MQTT_MAX_MESSAGE_SIZE)));
            }
                    ...
                    .setDfsHaAutomaticFailoverEnabled(
                            Boolean.parseBoolean(
                                    properties.getProperty(
                                            "dfs_ha_automatic_failover_enabled",
                                            String.valueOf(
                                                    conf.isDfsHaAutomaticFailoverEnabled()))));
            TSFileDescriptor.getInstance()
                    .getConfig()
            ...
            TSFileDescriptor.getInstance()
                    ...
                    .setKerberosPrincipal(
                            properties.getProperty(
                                    "kerberos_principal", conf.getKerberosPrincipal()));
    ...
    private void loadWALProps(Properties properties) {
        conf.setEnableWal(
                Boolean.parseBoolean(
                        properties.getProperty(
                                "enable_wal", Boolean.toString(conf.isEnableWal()))));
    ...
    public void loadHotModifiedProps(Properties properties) throws QueryProcessException {
        try {
            ...
            conf.setSlowQueryThreshold(
                    Long.parseLong(properties.getProperty("slow_query_threshold")));
