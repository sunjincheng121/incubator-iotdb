...
public class MeasurementMNode extends MNode {
    ...
    public void serializeTo(BufferedWriter bw) throws IOException {
        ...
        StringBuilder s =
                new StringBuilder(String.valueOf(MetadataConstant.MEASUREMENT_MNODE_TYPE));
     ...
     *     "2,s0,speed,2,2,1,year:2020;month:jan;,-1,0" representing: [0] nodeType [1] name [2]
     *     alias [3] TSDataType.ordinal() [4] TSEncoding.ordinal() [5] CompressionType.ordinal() [6]
     *     props [7] offset [8] children size
     */
