            ...
            pageReader -> {
              if (chunkMetaData.isSeq()) {
                ...
                if (orderUtils.getAscending()) {
                  seqPageReaders.add(
                      new VersionPageReader(chunkMetaData.getVersion(), pageReader, true));
                } else {
                  seqPageReaders.add(
                      0, new VersionPageReader(chunkMetaData.getVersion(), pageReader, true));
                }

              } else {
                unSeqPageReaders.add(
                    new VersionPageReader(chunkMetaData.getVersion(), pageReader, false));
              }
            });
  }
