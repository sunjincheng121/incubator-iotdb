...
public class InsertTabletPlan extends InsertPlan {
    ...
    // indicate whether this plan has been set 'start' or 'end' in order to support plan
    // transmission without data loss in cluster version
    ...
    public int hashCode() {
        int result =
                Objects.hash(timeBuffer, valueBuffer, rowCount, maxTime, minTime, paths, range);
    ...
    public void checkIntegrity() throws QueryProcessException {
        ...
        for (Object value : columns) {
            if (value == null) {
                throw new QueryProcessException(
                        "Columns contain null: " + Arrays.toString(columns));
            }
        }
    }
}
