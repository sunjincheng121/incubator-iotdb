...
public class MergeUtils {
    ...
    public static long[] findTotalAndLargestSeriesChunkNum(
        ...
        for (Path path : paths) {
            ...
            maxChunkNum =
                    chunkMetadataList.size() > maxChunkNum ? chunkMetadataList.size() : maxChunkNum;
        }
        logger.debug(
    ...
    public static long getFileMetaSize(
            TsFileResource seqFile, TsFileSequenceReader sequenceReader) {
     ...
     * this method follows the order of positions of chunks instead of the order of timeseries,
     * which reduce disk seeks.
     *
