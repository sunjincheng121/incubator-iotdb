...
public interface ILogWriter {
     ...
     * if the OS/FileSystem you are using do not guarantee strong persistency and you want the logs
     * to be persisted immediately, please call force() after calling this method. Notice: do not
     * flip the buffer before calling this method
     *
