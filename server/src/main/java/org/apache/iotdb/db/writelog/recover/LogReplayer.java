...
public class LogReplayer {
    ...
    /**
     * finds the logNode of the TsFile given by insertFilePath and logNodePrefix, reads the WALs
     * from the logNode and redoes them into a given MemTable and ModificationFile.
     */
    ...
    private void replayInsert(InsertPlan plan) throws WriteProcessException, QueryProcessException {
        ...
        // set measurementMNodes, WAL already serializes the real data type, so no need to infer
        // type
