    ...
    public static void updateSchemaDataTypeNum(
        ...
        for (Map.Entry<TSDataType, Integer> entry : schemaDataTypeNumMap.entrySet()) {
            ...
            bufferedArraysNumRatio.put(
                    dataType, (double) schemaDataTypeNumMap.get(dataType) / total);
        }
    }

    /**
     * check whether the ratio of buffered array of specific data type reaches the ratio in schema
     * (as recommended ratio)
     *
     * @param dataType data type
