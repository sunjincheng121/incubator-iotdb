...
public class TsFileResource {
    ...
    void moveTo(File targetDir) {
        ...
        fsFactory.moveFile(
                fsFactory.getFile(file.getPath() + ModificationFile.FILE_SUFFIX),
    ...
    public long getTimePartition() {
        if (deviceToIndex != null && !deviceToIndex.isEmpty()) {
            return StorageEngine.getTimePartition(
    ...
    public TsFileResource createHardlink() {
        ...
        while (true) {
            ...
            try {
                Files.createLink(
                        Paths.get(hardlink.getAbsolutePath()), Paths.get(file.getAbsolutePath()));
    ...
    public boolean isPlanRangeCovers(TsFileResource another) {
        return this.minPlanIndex <= another.minPlanIndex
                && another.maxPlanIndex <= this.maxPlanIndex;
    }
