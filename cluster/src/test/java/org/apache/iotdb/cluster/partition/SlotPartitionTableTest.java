...
public class SlotPartitionTableTest {
    ...
    public void testPhysicalPlan() throws QueryProcessException, IllegalPathException {
        ...
        PhysicalPlan localLoadConfigPlan =
                new LoadConfigurationPlan(LoadConfigurationPlanType.LOCAL);
    ...
    public void testCountPlan() throws IllegalPathException {
        PhysicalPlan countPlan1 =
                new CountPlan(
                        ...
                        new PartialPath("root.sg.*.l3" + ".l4.28.*"));
        ...
        PhysicalPlan countPlan3 =
                new CountPlan(
                        ...
                        new PartialPath("root.sg" + ".l2.l3.l4.28"));
        PhysicalPlan countPlan4 =
                new CountPlan(
                        ShowContentType.COUNT_NODE_TIMESERIES,
                        new PartialPath("root.sg" + ".l2.l3"),
                        6);
    ...
    public void testShowChildPathsPlan() throws IllegalPathException {
        PhysicalPlan showChildPathsPlan1 =
                new ShowChildPathsPlan(
                        ShowContentType.CHILD_PATH, new PartialPath("root.sg.l2.l3.l4.28"));
        PhysicalPlan showChildPathsPlan2 =
                new ShowChildPathsPlan(
                        ShowContentType.CHILD_PATH, new PartialPath("root.sg.l2.l3.l4"));
        try {
