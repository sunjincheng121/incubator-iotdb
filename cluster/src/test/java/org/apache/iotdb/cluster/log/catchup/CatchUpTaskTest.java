                ...
                public AsyncClient getAsyncClient(Node node) {
                    return new TestAsyncClient() {
                        ...
                        public void appendEntry(
                            ...
                            new Thread(() -> resultHandler.onComplete(dummyAppendEntry(request)))
                                    .start();
                        }
                        ...
                        public void appendEntries(
                                ...
                                AsyncMethodCallback<Long> resultHandler) {
                            new Thread(() -> resultHandler.onComplete(dummyAppendEntries(request)))
                                    .start();
                        }
                        ...
                        public void matchTerm(
                            ...
                            new Thread(() -> resultHandler.onComplete(dummyMatchTerm(index, term)))
                                    .start();
                        }
