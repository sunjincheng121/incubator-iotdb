...
public class ClusterDescriptor {
    ...
    private void loadProps() {
        ...
        config.setMinNumOfLogsInMem(
                Integer.parseInt(
                        properties.getProperty(
                                ...
                                String.valueOf(config.getMinNumOfLogsInMem()))));
        ...
        config.setFlushRaftLogThreshold(
                Integer.parseInt(
                        properties.getProperty(
                                "flush_raft_log_threshold",
                                String.valueOf(config.getFlushRaftLogThreshold()))));

        config.setRaftLogBufferSize(
                Integer.parseInt(
                        properties.getProperty(
                                "raft_log_buffer_size",
                                String.valueOf(config.getRaftLogBufferSize()))));
