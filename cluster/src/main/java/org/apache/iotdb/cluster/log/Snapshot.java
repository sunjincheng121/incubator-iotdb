...
public abstract class Snapshot {
    ...
    /**
     * Discard contents which is generated by logs whose index <= 'minIndex' if possible. This
     * method is a best-effort one without guarantee that the result will absolutely not contain
     * contents before 'minIndex'.
     *
     * @param minIndex
     */
