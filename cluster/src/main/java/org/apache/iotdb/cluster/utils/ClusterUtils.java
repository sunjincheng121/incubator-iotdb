...
public class ClusterUtils {
     ...
     * ClusterConfig#getInternalDataPort()}, which means the dataHeartbeatPort =
     * getInternalDataPort() + DATA_HEARTBEAT_OFFSET.
     */
    public static final int DATA_HEARTBEAT_PORT_OFFSET = 1;

    /**
     * the meta group member's heartbeat offset relative to the {@link
     * ClusterConfig#getInternalMetaPort()} ()}, which means the metaHeartbeatPort =
     * getInternalMetaPort() + META_HEARTBEAT_OFFSET.
     */
    ...
    public static CheckStatusResponse checkStatus(
        ...
        if (localStartUpStatus.getPartitionInterval()
        ...
        if (localStartUpStatus.getReplicationNumber()
    ...
    public static boolean analyseStartUpCheckResult(
            int consistentNum, int inconsistentNum, int totalSeedNum)
                ...
                new ThreadPoolExecutor(
                        ...
                        new ThreadFactory() {
                            ...
                            public Thread newThread(Runnable r) {
                                return new Thread(
                                        r, clientThreadPrefix + threadIndex.incrementAndGet());
                            }
                        }));
    ...
    public static Node stringToNode(String str) {
        ...
        int idFirstPos =
                str.indexOf("nodeIdentifier:", metaPortLastPos) + "nodeIdentifier:".length();
