...
public class DataAsyncService extends BaseAsyncService implements TSDataService.AsyncIface {
    ...
    public void getChildNodePathInNextLevel(
        ...
        try {
            dataGroupMember.syncLeaderWithConsistencyCheck(false);
            resultHandler.onComplete(
                    ((CMManager) IoTDB.metaManager).getChildNodePathInNextLevel(path));
        } catch (CheckConsistencyException | MetadataException e) {
            resultHandler.onError(e);
        }
    }
    ...
    public void getAggrResult(
        ...
        try {
            resultHandler.onComplete(
                    dataGroupMember.getLocalQueryExecutor().getAggrResult(request));
    ...
    public void getUnregisteredTimeseries(
        ...
        try {
            resultHandler.onComplete(
                    dataGroupMember
                            .getLocalQueryExecutor()
                            .getUnregisteredTimeseries(timeseriesList));
        } catch (CheckConsistencyException e) {
            resultHandler.onError(e);
        }
    }
    ...
    public void getGroupByExecutor(
        ...
        try {
            resultHandler.onComplete(
                    dataGroupMember.getLocalQueryExecutor().getGroupByExecutor(request));
