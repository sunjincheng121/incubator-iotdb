 ...
 * value is a PartitionGroup with contains all nodes that manage the corresponding data. currently,
 * we do not support auto-create storage group in the cluster mode.
 */
