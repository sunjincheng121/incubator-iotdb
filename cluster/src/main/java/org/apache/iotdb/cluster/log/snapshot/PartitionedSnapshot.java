...
public class PartitionedSnapshot<T extends Snapshot> extends Snapshot {
    ...
    public class Installer implements SnapshotInstaller<PartitionedSnapshot> {
        ...
        /**
         * Install a PartitionedSnapshot, which is a slotNumber -> FileSnapshot map. Only the slots
         * that are managed by the the group will be applied. The lastLogId and lastLogTerm are also
         * updated according to the snapshot.
         *
         * @param snapshot
         */
