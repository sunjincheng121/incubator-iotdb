...
public abstract class RaftServer implements RaftService.AsyncIface, RaftService.Iface {
    ...
    /**
     * Establish a thrift server with the configurations in ClusterConfig to listen to and respond
     * to thrift RPCs. Calling the method twice does not induce side effects.
     *
    ...
    /**
     * Stop the thrift server, close the socket and interrupt all in progress RPCs. Calling the
     * method twice does not induce side effects.
     */
    public void stop() {
        if (poolServer == null) {
            return;
                ...
                new ThreadPoolExecutor(
                        ...
                        new ThreadFactory() {
                            ...
                            public Thread newThread(Runnable r) {
                                return new Thread(
                                        r, getClientThreadPrefix() + threadIndex.incrementAndGet());
                            }
                        }));
